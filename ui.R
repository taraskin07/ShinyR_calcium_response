...
ui <- navbarPage(
  ...
  tabPanel(
    ...
    sidebarLayout(
      ...
      mainPanel(
        h3(class = "center-h3", "Average"),
        plotlyOutput("plot_average_out"),
        h3(class = "center-h3", "Single plot"),
        plotlyOutput("plot_single_out"),
        h3(class = "center-h3", "Rotated single plot"),
        plotlyOutput("plot_single_out2"),
        h3(class = "center-h3", "Rotated data"),
        DT::dataTableOutput('data_to_rotate_out2'),
        h3(class = "center-h3", "Rotated average"),
        plotlyOutput("plot_average_out2"),
        h3(class = "center-h3", "Single plot with area"),
        plotlyOutput("plot_single_area_out"),
        h3(class = "center-h3", "Area calculations"),
        DT::dataTableOutput('area_data_out'),
        h3(class = "center-h3", "Area statistics"),
